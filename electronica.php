...
<head>
    ...
    <title>Digital RP | Electronica</title>
        ...
        <div class="header-content">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="electronica.php" class="active">Electrónica</a></li>
...
<section class="featured">
    <div class="featured-container">
        <h2 class="section-title">Productos de Electrónica</h2>
        <div class="products-grid" id="electronica-products">
...
<a href="https://wa.me/573001234567?text=Hola,%20estoy%20interesado%20en%20sus%20productos%20de%20electronica" class="whatsapp-float" target="_blank">
    📱
</a>
...
// ===============================
window.addEventListener('DOMContentLoaded', cargarProductosElectronica);
