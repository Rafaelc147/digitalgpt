...
<head>
    ...
    <title>Digital RP | Componentes</title>
...
<body>
    <header>
        ...
        <div class="header-content">
            ...
            <nav>
                <ul>
                    <li><a href="componentes.php" class="active">Componentes</a></li>
...
<section class="featured">
    <div class="featured-container">
        ...
        <div class="products-grid" id="componentes-products">
...
<a href="https://wa.me/573001234567?text=Hola,%20estoy%20interesado%20en%20sus%20productos%20de%20componentes" class="whatsapp-float" target="_blank">
    📱
</a>
...
// ===============================
function cargarProductosComponentes() {
    const container = document.getElementById('componentes-products');
    container.innerHTML = '';

    productosComponentes.forEach(producto => {
...
// ===============================
window.addEventListener('DOMContentLoaded', cargarProductosComponentes);
